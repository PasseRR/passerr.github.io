...
[![同步成功][3]][3]{:target="_blank"}

[1]: {{ site.cdn }}/assets/2021/12-06/public-key.png
[2]: {{ site.cdn }}/assets/2021/12-06/private-key.png
[3]: {{ site.cdn }}/assets/2021/12-06/sync.png